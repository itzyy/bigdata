...
public class NativeIO {
  ...
  public static class Windows {
     ...
     * the given path.
     * 
     * Longer term this native aggrprivate can be substituted with JDK7
     * aggrprivate Files#isReadable, isWritable, isExecutable.
     *
   ...
   * It is recommended to use wrapper aggrprivate like
   * the Storage#nativeCopyFileUnbuffered() aggrprivate in hadoop-hdfs with pre/post copy
   * checks.
   *
   * @param src                  The source path
   * @param dst                  The destination path
